...
const QuestionnaireDisplay = () => {
  ...
  useEffect(() => {
    const fetchOriginalData = async () => {
      setLOader(true);
      try {
        const response = await axios.get('/api/setting/getQuestionnaire');
        setOriginalQuestionnaires(response.data.message);
  ...
  const deleteQuestionnaire = async (questionnaireId) => {
    try {
      await axios.delete('/api/setting/deleteQuestionnaire', {
