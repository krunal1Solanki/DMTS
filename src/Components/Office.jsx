...
const Office = () => {
    ...
    const fetchOfficeData = async () => {
        try {
            const info = await axios.get('/api/setting/getOffice');
            setOfficeData(info.data.data);
        } catch (error) {
            console.error(error);
        }
    };
    ...
    const handleAddOffice = async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/setting/addOffice', formData);
    ...
    const handleUpdateOffice = async () => {
        ...
        try {
            ...
            const response = await axios.post(`/api/setting/editOffice`, formData);
            console.log(response.data.message);
    ...
    const handleDeleteOffice = async (officeId) => {
        try {
            ...
            const response = await axios.post(`/api/setting/deleteOffice`, {officeId});
            console.log(response.data.message);
